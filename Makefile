# This Makefile is for the Test::More::Behaviours extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=/Users/rijam/Projects/perl])
#
#   MakeMaker Parameters:

#     ABSTRACT_FROM => q[lib/Test/More/Behaviours.pm]
#     AUTHOR => q[Rija Menage <cpan@rijam.sent.as>]
#     NAME => q[Test::More::Behaviours]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], version=>q[0] }
#     VERSION_FROM => q[lib/Test/More/Behaviours.pm]
#     clean => { FILES=>q[Test-More-Behaviours-*] }
...
INSTALLDIRS = site
DESTDIR = 
PREFIX = /Users/rijam/Projects/perl
PERLPREFIX = $(PREFIX)
SITEPREFIX = $(PREFIX)
VENDORPREFIX = $(PREFIX)
...
INSTALLSITEARCH = $(SITEPREFIX)/lib/perl5/site_perl/5.8.6/darwin-thread-multi-2level
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = $(VENDORPREFIX)/lib/perl5/5.8.6/darwin-thread-multi-2level
...
FULLEXT = Test/More/Behaviours
BASEEXT = Behaviours
PARENT_NAME = Test::More
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Test/More/Behaviours.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Test/More
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Test/More
...
TO_INST_PM = lib/Test/More/Behaviours.pm

PM_TO_BLIB = lib/Test/More/Behaviours.pm \
...
DISTNAME = Test-More-Behaviours
DISTVNAME = Test-More-Behaviours-0.0.2
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Test/More/Behaviours.pm $(INST_MAN3DIR)/Test::More::Behaviours.$(MAN3EXT) 
...
clean :: clean_subdirs
	-$(RM_RF) Test-More-Behaviours-* ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all $(INST_ARCHAUTODIR)/extralibs.ld perlmain.c tmon.out mon.out so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe perl perl$(EXE_EXT) $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def lib$(BASEEXT).def $(BASEEXT).exp $(BASEEXT).x core core.*perl.*.? *perl.core core.[0-9] core.[0-9][0-9] core.[0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9][0-9]
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Test/More/Behaviours.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Test-More-Behaviours' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.0.2' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Test/More/Behaviours.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Test::More:                    0' >> META.yml
	$(NOECHO) $(ECHO) '    version:                       0' >> META.yml
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "PREFIX=/Users/rijam/Projects/perl"
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Group Test::More assertions into behaviours</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Rija Menage &lt;cpan@rijam.sent.as&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Test/More/Behaviours.pm blib/lib/Test/More/Behaviours.pm 
	$(NOECHO) $(TOUCH) $@
